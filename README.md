...
The primary purpose of this project was to improve my understanding of regular expressions.  Rather than implementing a tokenizer/parser system, the program applies regular expressions extensively to identify language elements within the user's text.  It also works directly with raw HTML pulled from the editable \<div\>, which provided some interesting challenges.  The finished product is certainly not perfect, but creating it was a very informative experience.
