...
Version 3 adds support for importing header files into the context of the current text.  This brings in typedefs, macros, and other elements defined in the header file and uses the information to color-code the current text accordingly.
